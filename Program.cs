...
// The user can choose Easy, Medium, or Hard difficulty, which affects the range of numbers and the number of attempts allowed.
            ...
            while (guess != number && guesses < maxAttempts)
            {
                ...
                if (!int.TryParse(input, out guess)) 
              {
                ...
                if (guess > number)
                    ...
                    Console.WriteLine($"WOW! Congratulations🎉 You Win! You guessed it in {guesses} attempt(s).");
            }
